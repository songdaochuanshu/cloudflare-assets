...
async function main() {
  ...
  writeFileSync('output/non-lolicon-images.json', JSON.stringify(nonLoliconImages, null, 2));
  writeFileSync('output/lolicon-images.json', JSON.stringify(loliconImages, null, 2));
