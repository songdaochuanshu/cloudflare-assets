...
// 读取现有数据
const rawData = JSON.parse(readFileSync(INPUT_PATH, 'utf8'));

// 检查是否已经是分类结构
if (!Array.isArray(rawData) && rawData.r18 && rawData.normal) {
...
console.log(`读取到 ${rawData.length} 张图片（扁平数组）`);
console.log('');
